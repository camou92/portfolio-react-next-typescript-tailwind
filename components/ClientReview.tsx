  ...
  return (
    <div className='flex flex-col text-center justify-center'>
        ...
        <p className='text-[16px] text-white opacity-50 w-[90%] md:w-[50%] mx-auto'>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi a minus est, praesentium natus cumque sint perferendis veritatis ratione quaerat libero. Dolores, nesciunt. Repudiandae, hic!
        </p>
    </div>
  )
}
